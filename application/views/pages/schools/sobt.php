	...
	<div class="col-md-9" style="padding-right:30px; border-right: 2px solid #ccc;">        
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				The School of Biotechnology is located in a state of the art building
which incorporates both teaching and research facilities. Biotechnology
combines disciplines like genetics,molecular biology, biochemistry,
microbiology, immunology and cell biology, which are in turn linked to
practical disciplines like chemical engineering, informationtechnology,
and biorobotics.
			</div>
		</div>
