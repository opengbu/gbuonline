...
<div class="page-header" style = "background-color: darkred; padding-top: 10px; padding-left: 50px; margin-top: 15px;">
    ...
    <h1> School of Buddhist Studies And Civilization
    <br>
    <small>Where Buddhist Ethics are applied in real life!!!</small>
    </h1>
            </font>
</div>
	...
	<div class="col-md-9" style="padding-right:30px; border-right: 2px solid #ccc;">        
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				jannas ajfnanja a jfnjanfja a f d agd hjansjdnkam agssdvhandm
				<br>
				jannas ajfnanja a jfnjanfja a f d agd hjansjdnkam agssdvhandm
				<br>
				jannas ajfnanja a jfnjanfja a f d agd hjansjdnkam agssdvhandm
