                ...
                <ul>
                    <i>
                        ...
                        <hr>
                            <div class="row">
                            <div class="col-sm-6">
                                <img src="<?php echo base_url('resources/images/sarthak.jpg')?>" height ="120" width="120"><br>SARTHAK GARG (Front End Designer)<br>
                            </div>
                                <div class="col-sm-6">
    ...
    <div class="modal fade bs-example-modal-lg-3" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                &nbsp; * <a href="https://groups.google.com/forum/#!forum/civil-2014-gbu">civil 2014-gbu</a><br><hr>
                </center>
                        </div>
        </div>
    </div>
