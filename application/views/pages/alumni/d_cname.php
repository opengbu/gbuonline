...
<div class="row">
    ...
    <div class="jumbotron" >
        ...
        <?php
            $r=$this->db->query("select users.username,edu_info.course_name,work_details.location,work_details.company_name from users,edu_info,alumni_basic,work_details order by course_name");
            $results=$r->result();
