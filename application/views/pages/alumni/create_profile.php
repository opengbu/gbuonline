<div class="container-fluid" style=" margin-right: 10px; margin-left: 10px;" >
    <div class="row">
        ...
        <?php echo form_open('Alumni_profile/create'); ?>

        <p>
            <label for="dob">Date Of birth <span class="required">*</span></label>
            <?php echo form_error('dob'); ?>
            <br /><input class="form-control" id="dob" type="text" name="dob" maxlength="100" value="<?php echo set_value('dob'); ?>"  />
        </p>

        <p>
            <label for="address">Address <span class="required">*</span></label>
            <?php echo form_error('address'); ?>
            <br /><input class="form-control" id="address" type="text" name="address"  value="<?php echo set_value('address'); ?>"  />
        </p>
        ...
        <p>
            ...
            <br /><?php echo form_dropdown('gender', $options, set_value('gender'), 'class="selectpicker"') ?>
        </p>                                             
        ...
        <p>
            ...
            <br /><?php echo form_dropdown('marital_status', $options, set_value('marital_status'), 'class="selectpicker"') ?>
        </p>                                             
