<div class="dropdown" style="margin-left:970px;size:25px">
    ...
    <div class="jumbotron" >
        ...
        <?php
            $r=$this->db->query("select users.username,edu_info.course_name,work_details.location,work_details.company_name from users,edu_info,alumni_basic,work_details where users.user_id=alumni_basic.user_id order by username");
            $results=$r->result();
