<div class="container-fluid" style=" margin-right: 10px; margin-left: 10px;" >
    ...
    <div class="jumbotron" >
        ...
        <?php
            $r=$this->db->query("select users.username,edu_info.course_name,work_details.location,work_details.company_name from users,edu_info,alumni_basic,work_details where users.user_id=alumni_basic.user_id and work_details.distinguished=1 order by location");
            $results=$r->result();
