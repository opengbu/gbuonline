...
<li role="presentation"><a href="<?= site_url('alumni');?>">Alumni Home</a></li>
  ...
  <li role="presentation" class="active"><a href="<?= site_url('alumni/events');?>">Alumni Events</a></li>
  <li role="presentation"><a href="<?= site_url('alumni/gallery');?>">Alumni Gallery</a></li>
  <li role="presentation"><a href="<?= site_url('alumni/alumni_profile');?>">Alumni Profiles</a></li>
		</ul>
	</div>
		<br> 
