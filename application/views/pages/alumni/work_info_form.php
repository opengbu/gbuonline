<div class="container-fluid" style=" margin-right: 10px; margin-left: 10px;" >
    <div class="row">
        ...
        <p>
            ...
            <br /><input class="form-control"  id="company_name" type="text" name="company_name" maxlength="50" value="<?php echo set_value('company_name'); ?>"  />
        </p>

        <p>
            <label for="location">Location</label>
            <?php echo form_error('location'); ?>
            <br /><input class="form-control" id="location" type="text" name="location" maxlength="100" value="<?php echo set_value('location'); ?>"  />
        </p>

        <p>
            <label for="start_year">Start Year <span class="required">*</span></label>
            <?php echo form_error('start_year'); ?>
            <br /><input class="form-control" id="start_year" type="text" name="start_year" maxlength="15" value="<?php echo set_value('start_year'); ?>"  />
        </p>

        <p>
            <label for="end_year">End Year (Enter CURRENT in case of ongoing) <span class="required">*</span></label>
            <?php echo form_error('end_year'); ?>
            <br /><input class="form-control" id="end_year" type="text" name="end_year" maxlength="15" value="<?php echo set_value('end_year'); ?>"  />
        </p>
        ...
        <p>
            ...
            <br /><input class="form-control" id="designation" type="text" name="designation" maxlength="100" value="<?php echo set_value('designation'); ?>"  />
        </p>
