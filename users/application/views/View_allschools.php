...
foreach ($query->result() as $row)
{
    ?>
            ...
            <div class="col-sm-2">
                        ...
                        <?php
            if ($current_user_type=="admin")  echo  '<a class="btn btn-xs btn-default " href="'. base_url()."index.php/Edit_table/index/$row->sc_name".'"><i class="fa fa-pencil fa-fw"></i>Edit</a>';
