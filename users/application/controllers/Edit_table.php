...
class Edit_table extends CI_Controller {
    ...
    function index($tbname = '-1') 
    {
        ...
        if($this->session->userdata('type')!='admin')
        {
         ...
         if($tbname==-1 ) redirect('/all_schools');//wrong url?
        ...
        else 
        {
             ...
             $query2=$this->db->query("update schools set sc_full_name = '$sc_full_name',about_us = '$about_us',course_structure='$course_structure',faculty='$faculty',events='$events',placements='$placements' where sc_name='$tbname'");
