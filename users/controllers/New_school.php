...
class New_school extends CI_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->db->query("insert into schools (sc_name,sc_full_name,about_us,course_structure,faculty,placements,tagline) values ('$sc_name','$sc_full_name','$about_us','$course_structure','$faculty','$placements','$tagline')");
