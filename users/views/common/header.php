...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url() . 'views/common/' . 'dist/css/bootstrap-select.css' ?>">
        <link rel="stylesheet" href="<?php echo base_url() . 'views/common/' . 'css/bootstrap.min.css' ?>">
        <link rel="stylesheet" href="<?php echo base_url() . 'views/common/' . 'css/font-awesome.min.css' ?>">
        ...
        <script type="text/javascript" src="<?php echo base_url() . 'views/common/' . 'dist/js/bootstrap-select.js' ?>"></script>
