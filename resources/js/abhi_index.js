...
(function(n) {
  ...
  c.prototype.c = function(a) {
    var b,
      c, f, h, d, l;
    for (c = a.length; c;)
      for (h = a[--c], f = a[--c], b = c; b;)
        if (l = a[--b], d = a[--b], f === d && h === l || f === l && h === d) {
          a.splice(c, 2);
          a.splice(b, 2);
          break
        }
...
(function(n) {
  ...
  function r(d, a, b, f, k) {
    ...
    g.push([0, k - a]);
    g.push([0, k - a / 2]);
    for (b = 6; 0 <= b; b--) g.push([0 + Math.random() * d, k]), g.push([0, k - Math.random() * a]), g.push([0 + d, k - Math.random() * a]), g.push([0 + Math.random() * d, k - a]);
  ...
  function h(b, c, m, h) {
    function k() {
      e.a.I() && e.a.A();
      if (0 == n || n != e.b.offsetWidth + e.b.offsetHeight) n = e.b.offsetWidth + e.b.offsetHeight, g(), e.a.A();
  ...
  b.prototype.u = function() {
    return this.c(this.s(), {
      ...
      style: "fill: " + this.m.toString() + "; stroke: " + this.m.toString() + ";"
    })
  };
  u(c, b);
  c.a = b.a;
